export default async function handler(req, res) {
  ...
  try {
    ...
    params.append('success_url', 'https://drill-gen.vercel.app/upgrade-success.html?session_id={CHECKOUT_SESSION_ID}');
    params.append('cancel_url', 'https://drill-gen.vercel.app/pricing.html');
